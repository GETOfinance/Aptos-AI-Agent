...
Trade and infrastructure for complex agent interactions within the Aptos ecosystem.
...
In other words, the Aptos AI Agent is built with three main files:
...
```bash
git clone https://github.com/GETOfinance/Aptos-AI-Agent.git aptos-agent
cd Aptos-AI-Agent
```
...
> [!NOTE]
> We need python version 3.10 or higher to work with the AI Agent library `swarm`, use `pyenv` to do so.
